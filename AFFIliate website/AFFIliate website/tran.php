...
?> ₹ </a>
  ...
  <div class="cont2">
    <h2>Transaction record of <?php print_r($_SESSION['username']); ?></h2><h6>upto 20 record only<h6>
...
<?php
             ...
             if(!$conn){
               ...
               $sql = "SELECT * FROM `ptr` WHERE uname='$alpha' ORDER BY `s.no` DESC  LIMIT 20 ";
               $result=mysqli_query($conn,$sql);
               ...
               if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                  ...
                  echo "<ul><li>Your request of " . $row["amount"]. " ₹  was " . $row["upd"]. " Request date and time :-".$row["Dt"]." </li></ul> <hr><br>";
                
              }
              } else {
                echo "0 Transaction found";
              }
